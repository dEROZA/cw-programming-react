...
class UserForm extends React.Component {
  ...
  methodReCheckData = () => {
    switch (this.state.currentStep) {
      case 1: {
        this.state.activestate = this.state.username.match(/^(\w+\s?\w+)$/) !== null; break;
      }
      case 2: {
        this.state.activestate = this.state.email.match(/^(\w+\@\w+\.\w+)$/) !== null; break;
      }
      case 3: {
        this.state.activestate = this.state.password.match(/^(\w+|\~+|\*+|\@+|\#+)$/) !== null; break;
      }
      default: break;
    }
